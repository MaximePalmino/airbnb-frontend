       ...
       <div className="container">
        ...
        <div className="section">
            <div className="information">
                ...
                <hr />
                <h4><b>Enchanced Clean</b></h4>
                <p>This host is commited to Airbnb's 5-steps enhanced cleaning process.</p>
            ...
            <div className="price-box">
                        ...
                        <Link href="/"><div className="button" onClick={() => {}}>Change Dates</div></Link>
